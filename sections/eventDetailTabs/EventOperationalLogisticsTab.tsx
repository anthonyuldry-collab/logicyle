        ...
        if (leg.departureDate && leg.departureTime) {
            ...
            if (targetDay) {
                ...
                timings.push({
                    ...
                    description: `🚗 Départ ${leg.direction} - ${vehicleInfo}${driverInfo} - De: ${leg.departureLocation || 'N/A'}`,
        ...
        if (leg.arrivalDate && leg.arrivalTime) {
            ...
            if (targetDay) {
                ...
                timings.push({
                    ...
                    description: `🏁 Arrivée ${leg.direction} - ${vehicleInfo}${driverInfo} - À: ${leg.arrivalLocation || 'N/A'}`,
                    isAutoGenerated: true,
                    targetMealDay: targetDay,
                    category: OperationalTimingCategory.TRANSPORT
                });
            ...
            leg.intermediateStops.forEach(stop => {
                ...
                if (targetDay && stop.time) {
                    ...
                    if (isSimpleFormat) {
                        ...
                        // Format simplifié pour les autres étapes
