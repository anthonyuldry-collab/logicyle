...
export default function EventBudgetTab({ 
  ...
  const calculateAccommodationBudgetItems = (): EventBudgetItem[] => {
    ...
    return accommodations
      ...
      .map(acc => ({
        ...
        notes: `Auto-généré depuis l'hébergement: ${acc.hotelName || 'Hôtel sans nom'}`,
      }));
  };
  ...
  useEffect(() => {
    ...
    setEventBudgetItems((prevBudget) => {
      ...
      // Ajouter les nouveaux éléments auto-générés
      const newAutoItems = [...accommodationItems, ...vacataireItems, ...vehicleItems];
